...
.curso-main-container.creditos-vista
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    p(data-aos="fade-up").mb-5 La unidad 2, tiene como propósito que los estudiantes desarrollen un plan estratégico detallado para la ejecución de proyectos, gestionando recursos y tiempos de manera eficiente.
